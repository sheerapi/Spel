...
spel_api bool spel_input_action(spel_action action); // digital: pressed, analog: non-zero
spel_api bool spel_input_action_pressed(spel_action action);  // digital only
spel_api bool spel_input_action_released(spel_action action); // digital only
spel_api float spel_input_action_value(
	spel_action action); // analog: -1 to 1, digital: 0 or 1
