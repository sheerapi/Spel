...
spel_hidden int32_t spel_gfx_find_block_by_set_binding(spel_gfx_shader_block* blocks,
												 uint32_t count, uint32_t binding, uint32_t set);
spel_hidden int32_t spel_gfx_find_sampler_by_set_binding(spel_gfx_shader_uniform* samplers,
												   uint32_t count, uint32_t binding, uint32_t set);
spel_hidden void spel_gfx_copy_block(spel_gfx_shader_block* dest,
								   const spel_gfx_shader_block* src);
spel_hidden void spel_gfx_copy_sampler(spel_gfx_shader_uniform* dest,
									 const spel_gfx_shader_uniform* src);
spel_hidden void spel_gfx_verify_block_compatibility(spel_gfx_shader_block* existing,
												   const spel_gfx_shader_block* newBlock);
spel_hidden void spel_gfx_verify_sampler_compatibility(
	spel_gfx_shader_uniform* existing, const spel_gfx_shader_uniform* newSampler);

spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_default()
{
...
spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_minimal(spel_gfx_shader vertex,
														spel_gfx_shader fragment)
{
	...
	static const spel_gfx_vertex_attrib ATTRIBS[] = {
		{.location = 0, .format = spel_gfx_vertex_format_float3, .offset = 0, .stream = 0}};
...
spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_vertex_color(spel_gfx_shader vertex,
															 spel_gfx_shader fragment)
{
	spel_gfx_pipeline_desc desc = spel_gfx_pipeline_default();
	desc.vertex_shader = vertex;
...
spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_textured(spel_gfx_shader vertex,
														 spel_gfx_shader fragment)
{
	spel_gfx_pipeline_desc desc = spel_gfx_pipeline_default();
...
spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_fullscreen(spel_gfx_context ctx,
														   spel_gfx_shader fragment)
{
	spel_gfx_pipeline_desc desc = spel_gfx_pipeline_default();
...
spel_api spel_gfx_pipeline_desc spel_gfx_pipeline_default_2d(spel_gfx_context ctx)
{
												   ...
												   const spel_gfx_shader_block* newBlock)
{
	...
	{
		spel_error(SPEL_ERR_SHADER_REFLECTION_MISMATCH,
