...
spel_api spel_gfx_rg_resource spel_gfx_rg_create_texture(spel_gfx_rg rg, const char* name,
												uint32_t width, uint32_t height,
												spel_gfx_texture_format format);

spel_api spel_gfx_rg_resource spel_gfx_rg_import_texture(spel_gfx_rg rg, const char* name,
												spel_gfx_texture texture);

// pass declaration
spel_api spel_gfx_rg_pass spel_gfx_rg_add_pass(spel_gfx_rg rg, const char* name,
									  spel_gfx_rg_setup_fn setup,
									  spel_gfx_rg_execute_fn execute, void* userData);

// resource access (called in setup callback)
spel_api void spel_gfx_rg_read(spel_gfx_rg_pass pass, spel_gfx_rg_resource resource);
spel_api void spel_gfx_rg_write(spel_gfx_rg_pass pass, spel_gfx_rg_resource resource,
...
spel_api spel_gfx_texture spel_gfx_rg_get_texture(spel_gfx_rg_pass pass,
